...
INSERT INTO stories (title, contributions, completed, author_id, votes, updated)
VALUES ('What Happens in Vegas', 'My cat, Oreo, is the best poker partner I have ever had. Hands down—no pun intended. Do not let those old Coolidge paintings fool you; dogs really do not know what the hell they are doing once you sit them on that rickety ladder back chair, and their paws just are not made for holding the cards steady. Trust me: If you want a reliable means of collusion in a game of Texas hold them, British Shorthairs are the way to go.', FALSE, 4, 8, 0);

INSERT INTO stories (title, contributions, completed, author_id, votes, updated)
VALUES ('The Lonely Color', '“... I want to paint you.”She was surprised, sure enough. But she was also curious. Her face concealed nothing, and that was what fascinated me. As she walked through the gallery, each piece evoked something unique from inside her, and she did not bother to mask it. Anyone could read the critique in her face, if they took the time. It is an artist dream – to clearly see the emotions we inspire with our work.Many had passed by my work since the showing began, pausing for a moment, offering a quick word of praise.', FALSE, 5, 5, 0);
